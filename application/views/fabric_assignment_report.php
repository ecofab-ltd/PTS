<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Fabric Assignment Report</h1>
        <h2 class="">Fabric Assignment Report...</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">Fabric Assignment Report</li>
        </ol>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <span><b> From Assignment Date </b></span>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <span><b> To Assignment Date </b></span>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <span class="btn btn-success" onclick="getFabricAssignmentFilterReport()">SEARCH</span>
                    </div>
                    <div class="col-md-1">
                        ...
                        <table class="display table table-bordered table-striped" id="">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center hidden-phone">Assignment Date</th>
                                    <th class="center hidden-phone">Update Date</th>
                                    <th class="center hidden-phone">Length (m)</th>
                                    <th class="center hidden-phone">Destination</th>
                            ...
                            foreach($fabric_assignment AS $fb){
                                ...
                                <tr>
                                    ...
                                    <td class="center hidden-phone"><?php echo $fb['assignment_date'];?></td>
                                    <td class="center hidden-phone"><?php echo $fb['update_date'];?></td>
                                    <td class="center hidden-phone"><?php echo $fb['cutting_assignment_length'];?></td>
                                    <td class="center hidden-phone"><?php echo $destination;?></td>
                                    <td class="center hidden-phone"><?php echo $fb['remarks'];?></td>
                                    <td class="center hidden-phone">
                                        <a href="<?php echo base_url()?>access/editFabricAssignment/<?php echo $fb['id'];?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
...
//            window.open("<?php //echo site_url('access/printQRCodes');?>///"+user_codes, "_blank");
    ...
    function getFabricAssignmentFilterReport() {
        ...
        if(from_date <= to_date) {
            $.ajax({
                url: "<?php echo base_url('access/getFabricAssignmentFilterReport')?>",
                type: "post",
                dataType: 'html',
                data: {fabric_id: fabric_code, destination_id: destination_id, from_date: from_date, to_date: to_date},
