                ...
                foreach($prod_summary as $k => $v) {
                    if (($v['count_input_qty_line'] - $v['count_end_line_qc_pass']) > 0) {
                        ...
                        <tr>
                            ...
                            <td class="hidden-phone center" style=""><?php echo $v['count_input_qty_line']; ?></td>
                            <td class="hidden-phone center" style="color: #ffffff; font-size: 20px; background-color: darkblue;"><?php echo $v['count_mid_line_qc_pass']; ?></td>
