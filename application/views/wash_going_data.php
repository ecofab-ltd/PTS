        ...
        <div class="table-responsive">
            <table class="display table table-bordered table-striped" id="">
                ...
                <tr>
                    ...
                    <th class="hidden-phone center"><span data-toggle="tooltip" title="Wash QTY">Wash Qty</span></th>
                ...
                <?php foreach($prod_summary as $k => $v) {
                    if (($v['count_end_line_qc_pass'] - $v['count_washing_qty']) > 0) {
                        ...
                        <tr>
                            ...
                            <td class="hidden-phone center" style="color: #ffffff; font-size: 20px; background-color: darkblue;"><?php echo $v['count_end_line_qc_pass']; ?></td>
                            <td class="hidden-phone center" <?php if($v['count_end_line_qc_pass'] > $v['count_washing_qty']){ ?>style="background-color: red;" <?php } ?> <?php if($v['count_end_line_qc_pass'] <= $v['count_washing_qty']){ ?>style="background-color: darkgreen;" <?php } ?>>
                                <span style="color: white; font-size: 20px;"><?php echo $v['count_washing_qty']; ?></span>
                            </td>
<!--                            <td class="hidden-phone center">-->
<!--                                --><?php //echo $v['count_end_line_qc_pass'] - $v['count_washing_qty']; ?>
<!--                            </td>-->
