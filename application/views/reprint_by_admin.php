...
<select name="reason" id="reason">
    ...
    <option value="Label Lost From Cutting">Label Lost From Cutting</option>
    <option value="Label Lost From Sewing">Label Lost From Sewing</option>
    <option value="Label Lost From Wash">Label Lost From Wash</option>
    <option value="Label Lost From Finishing">Label Lost From Finishing</option>
    <option value="Label Damaged Due To Printer">Label Damaged Due To Printer</option>
</select>

<input type="text" name="reference" id="reference" placeholder="Referenced By" />
<br />
<br />
...
<script type="text/javascript">
    ...
    function printDiv(divName) {
        ...
        if(pc_no != '' && reason != '' && reference != ''){
            ...
            $.ajax({
                url: "<?php echo base_url();?>access/keepReprintLogForAdmin/",
                type: "POST",
                data: {pc_no: pc_no, reason: reason, reference: reference, lost_point: lost_point, access_point: access_point, line_id: line_id},
                dataType: "html",
