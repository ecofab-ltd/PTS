<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Change-Line</h1>
        <h2 class="">Change-Line...</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">Change-Line</li>
        </ol>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="block-web">
            <div class="header">
                ...
                <h3 class="content-header">Change-Line</h3>
            </div>
        </div>
                                ...
                                <div id="set_form">
                                    <table class="display table table-bordered table-striped" id="sample_2">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="center">Assign From *</td>
                                                <td class="center">
                                                    <select id="line_no_from" name="line_no_from" required onchange="getTotalScannedQty();">
...
//        var cut_no = $("#cut_no").val();
        ...
        if(so_no != ''){
            $.ajax({
                url: "<?php echo base_url();?>access/getSizeBySo/",
                type: "POST",
                data: {so_no: so_no},
                dataType: "html",
