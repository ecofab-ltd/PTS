...
<div class="container clear_both padding_fix">
    <!--\\\\\\\ container  start \\\\\\-->
    <form action="<?php echo base_url();?>access/saveNewSubLineInfo" method="POST">
        <div class="row">
            <div class="col-md-12">
...
<!--        <div class="row">-->
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <input required="required" class="form-control" type="text" name="sub_line_name" id="sub_line_name" autocomplete="off" />
