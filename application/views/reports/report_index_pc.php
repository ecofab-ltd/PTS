        ...
        <div  id="reload_div">
            <div class="col-md-12 well1" id="tableWrap">
                <table class="table table-scroll table-striped" border="1" id="table_id">
                    <thead>
                    <tr>
                        <th class="" colspan="9" style="width: 48%"></th>
...
<!--                        <th class="" colspan="1" style="text-align: center;">Range</th>-->
                    ...
                    <tr>
                        ...
                        <th class=""><span data-toggle="tooltip" title="Planned Lines">PL</span></th>
...
<!--                                    <span style="color: #727dff; cursor: pointer;" onclick="getSizeWiseReport('--><?php //echo $v['po_no']; ?>//', '<?php //echo $v['so_no']; ?>//', '<?php //echo $v['purchase_order'];?>//','<?php //echo $v['item'];?>//', '<?php //echo $v['quality']; ?>//', '<?php //echo $v['color']; ?>//');">
                                    <span style="color: #727dff; cursor: pointer;" onclick="">
                                        <?php
                                        if($v['item'] != ''){
...
<!--                                <td class="" title="Bundles: --><?php //echo $v['bundle_start'].'-'.$v['bundle_end'];?><!--">--><?php //echo $v['min_care_label'].'-'.$v['max_care_label'];?><!--</td>-->
                                ...
                                <td class=""><?php echo $v['count_wash_going'];?></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>dashboard/getProductionSummaryReport/",
            type: "POST",
            data: {},
            dataType: "html",
        ...
        setInterval(function(){
            $("#reload_div").load('<?php echo base_url();?>dashboard/getProductionSummaryReport');
            $("#loader").css("display", "none");
        }, 300000);
