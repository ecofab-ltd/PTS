<table class="display table table-bordered table-striped" id="">
    ...
    <tbody>
        <tr style="background-color: #f7ffb0;">
            ...
            <th class="center"><a target="_blank" class="btn btn-warning" href="<?php echo base_url();?>dashboard/getDailyLayCutPackageReportDetail/<?php echo $search_date;?>"><?php echo $cutting_prod[0]['package_ready_qty'];?></a></th>
        </tr>
    </tbody>
</table>