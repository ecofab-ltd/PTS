                                ...
                                <table class="table table-bordered table-striped" id="" border="1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-phone center">Carton Output</th>
                                            <th class="hidden-phone center">Closed by Admin</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    $total_carton_output = 0;
                                    $total_carton_manual_output = 0;

                                    foreach($daily_output AS $v){

                                        $total_carton_output += $v['carton_output'];
                                        $total_carton_manual_output += $v['carton_manual_close'];
                                    ?>
                                        <tr>
                                            ...
                                            <td class="hidden-phone center"><?php echo $v['carton_output_date'];?></td>
                                            <td class="hidden-phone center"><?php echo $v['carton_output'];?></td>
                                            <td class="hidden-phone center"><?php echo $v['carton_manual_close'];?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="hidden-phone center"><?php echo $total_carton_output;?></td>
                                            <td class="hidden-phone center"><?php echo $total_carton_manual_output;?></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
