...
<!--                <th class="hidden-phone center" colspan="1">Range</th>-->
                <th class="hidden-phone center" colspan="2">Cutting</th>
...
//                if ((($v['count_cutting_collar_bundle_qty'] + $v['count_cutting_cuff_bundle_qty']) - ($v['count_collar_bundle_qty'] + $v['count_cuff_bundle_qty']) ) != 0) {


                // New Logic Start
                $cutting_collar = ($v['count_cutting_collar_bundle_qty'] != '' ? $v['count_cutting_collar_bundle_qty'] : 0);
                $cutting_cuff = ($v['count_cutting_cuff_bundle_qty'] != '' ? $v['count_cutting_cuff_bundle_qty'] : 0);
