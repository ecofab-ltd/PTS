...
//                $where";
    ...
    public function getLineProductionReport($line_no){
        $sql = "SELECT A.min_line_input_date_time, B.*, C.line_name, D.collar_bndl_qty, D.cuff_bndl_qty, D.po_type
                
                FROM (SELECT po_no, so_no, line_id, min_line_input_date_time 
